  ...
  <form class="modal-content animate" action="login1.php " method="POST">
    ...
    <div class="container">
	 <p><span class="error">* required field.</span></p>
      ...
      <input  type="text1" placeholder="Enter Username" name="user_name" required>
...
<div class="w3-container">
<div class="hk">
<button class="button3"  onclick="window.location.href='hire1.php'" style="vertical-align:middle"><span>Hire</span>
</div>
<div class="rt">
<button class="button3" onclick="window.location.href='k.php'" style="vertical-align:middle"><span>Work</span>
</div>
</div>
</div>
</div>
...
<div class="h">
<p  style="font-size:20px;"class="video"><b> Watch The Video And Find It Out.....????</b></p>
<ul>
<li style="color:red" class="video"><b>LOOK THROUGH PROJECTS</li><br>
<li style="color:red" class="video"><b>LOOK THROUGH DIFFRENT PROFILES</li><br>
<li style="color:red" class="video"><b>POST YOUR PROJECT</li><br>
<li style="color:red" class="video"><b>CREATE YOUR PERSONAL PROFILE</li><br>
<li style="color:red" class="video"><b>INTERACT WITH PROFESSIONALS</li><br>
</ul>
<iframe  class="yup" style="border:none" width="620" height="300"
...
<div class="row">
  <div class="column">
    <div class="card">
      ...
      <div class="container1">
        ...
        <p>Rudeboy.mehta1@gmail.com</p>
        <p><button class="button89" onClick="parent.location='http://www.gmail.com/'">Contact</button></p>
  ...
  <div class="column">
    <div class="card">
      ...
      <div class="container1">
        <h2>Rajendra Vishnoi</h2>
        <p class="title">Co Founder</p>
        <p>Designer</p>
        <p>vishnoi123@gmail.com</p>
        <p><button class="button89" onClick="parent.location='http://www.gmail.com/'">Contact</button></p>
      </div>
    </div>
  </div>
  <div class="column">
    <div class="card">
      ...
      <div class="container1">
        ...
        <p>dwivedi.deep.deep@gmail.com</p>
        <p><button class="button89" onClick="parent.location='http://www.gmail.com/'">Contact</button></p>
      </div>
    </div>
  </div>
